...
export const MAQUINAS_INICIAIS: Maquina[] = [
  // Setor Semissólidos — 4 máquinas (Norden I, Norden II, Norden III, Norden IV)
  {
    ...
    status: 'em_andamento',
    produtoAtualId: 'p-nord1-09',
    produtoAtualNome: 'CIMECORT CREM BG 30G',
    horaInicio: '06:30',
    previsaoTermino: '12:45',
    tempoEnvaseMinutos: 375,
  ...
  },
  {
    ...
    status: 'em_andamento',
    produtoAtualId: 'p-nord2-01',
    produtoAtualNome: 'BEPANTRIZ 50MG/G POM BG 30G',
    horaInicio: '07:00',
    previsaoTermino: '14:16',
    tempoEnvaseMinutos: 436,
    teveProblemaMecanico: false,
  },
  {
    id: 'm-semi-norden-3',
